...
const char* password = "12345678pt";
//======================================== 
...
void loop() {
  ...
  if(WiFi.status()== WL_CONNECTED) {
    ...
    http.begin("http://192.168.89.103/ESP32_Mysql_database/Final/getdata.php");  //--> Specify request destination
    ...
    http.begin("http://192.168.89.103/ESP32_Mysql_database/Final/updateDHT11data_and_recordtable.php");  //--> Specify request destination
    http.addHeader("Content-Type", "application/x-www-form-urlencoded");  //--> Specify content-type header
